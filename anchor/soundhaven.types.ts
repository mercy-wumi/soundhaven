...
export type Soundhaven = {
  address: "EDiN6Pvh3zDU7nNtvwsctwAnsnP4Cc8hYxnHjuPwQGxG";
  metadata: {
    name: "soundhaven";
    version: "0.1.0";
    spec: "0.1.0";
  ...
  instructions: [
    {
      name: "acceptPayment";
      discriminator: [16, 43, 253, 85, 86, 15, 24, 181];
      accounts: [
        {
          name: "payment";
          writable: true;
    ...
    {
      name: "createSong";
      discriminator: [127, 207, 208, 177, 26, 61, 248, 164];
      accounts: [
        {
          name: "song";
          writable: true;
    ...
    {
      name: "deleteSong";
      discriminator: [146, 88, 254, 164, 193, 81, 122, 206];
      accounts: [
        {
          name: "song";
          writable: true;
  ...
  accounts: [
    ...
    {
      name: "song";
      discriminator: [144, 84, 211, 50, 100, 5, 81, 24];
    },
    {
      name: "user";
