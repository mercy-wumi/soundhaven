  ...
  return (
    <div className="h-screen flex w-[1440px] mx-auto">
      ...
      <div className="w-[100%] py-10 px-6 h-screen overflow-y-scroll relative ">
        <div className="flex justify-between items-center fixed w-[1240px] z-30 mx-auto top-0">
          ...
          <WalletMultiButton>{`${publicKey.toBase58().substring(0, 7)}...`}</WalletMultiButton>
            <Image src="/avatar.svg" width={50} height={50} alt="profile" className="rounded-full" />
          </div>
        </div>
        <div className="flex gap-4 mt-8">
          <div className="w-2/3 px-6">
            <div className="relative mb-8 h-[250px]">
              <Image src="/music4.avif" alt="album" width={600} height={300} className="rounded-2xl w-full h-full object-cover absolute top-0 left-0 opacity-70" />
